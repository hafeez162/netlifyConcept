  ...
  <div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col">
            ...
            <p data-aos="fade-right" data-aos-easing="linear" data-aos-duration="600">
              Our diversified digital portfolio meet kind of your needs. The work will be
              done according to your instructions which will surely meet your level of
    ...
    <div class="contact">
      <div class="container">
        ...
        <div class="main_form">
          <form data-aos="flip-up" data-aos-easing="linear" data-aos-duration="800">
            <div class="row">
        ...
        <div class="col-xs-1 col-sm-1 col-md-6 col-lg-6 col-xl-6">
          <div class="soical-links">
            ...
            <div class="icon-box">
              ...
              <div class="soical-content">
                <h4>Location:</h4>
                <a href="https://goo.gl/maps/dJ9bYV77tBKdFSo5A"
